...
if(isset($_POST['process']) and $_POST['process']=='script2'){
	...
	for($id_user=$id;$id_user>0;$id_user=$id_user-1){
		...
		if($send=='1'){
			...
			$mail->setFrom('test@cvr.by', 'PoligraFF.by – № 1 в Беларуси');
									...
									<table align="left" class="column">
										<tr>
											<td>				
												...
												<a href="#" class="soc-btn fb" style="background-color: #3B5998!important;">VK</a> <a href="#" class="soc-btn gp">Youtube</a> 
												</p>
						
												<!-- Callout Panel -->
						<p class="callout">
							Вы хотите <a href="http://testemail.mvolna.by/user/unsubscribe/unsubscribe.php?id='.$id.'">отписаться от рассылки?</a>
						</p><!-- /Callout Panel -->
											</td>
										</tr>
									</table><!-- /column 1 -->	
